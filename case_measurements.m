...
angle_speed = deg2rad(120);
% Used trigonometries identities to solve.
vx = -speed_vehicle*cos((pi-angle_speed));  
vy = speed_vehicle*sin((pi-angle_speed));

birth_mean = [24; 30; vx; vy];
...
for i = 1:num_measurement
    ...
    ground_truth(i,8) = speed_vehicle * cos(((pi/2)-ground_truth(i,7)-angle_speed));                % radial velcoity
